...
import com.revii.storyapp.databinding.ActivityAddStoryBinding
import com.revii.storyapp.utils.createCustomTempFile
import com.revii.storyapp.utils.rotateImage
import com.revii.storyapp.utils.uriToFile
    ...
    private fun setupViewModel() {
        ...
        addStoryViewModel.hasUploaded.observe(this) { file ->
            if (file != null) {
                ...
                binding.ivThumbnail.setImageResource(R.drawable.revii2)
