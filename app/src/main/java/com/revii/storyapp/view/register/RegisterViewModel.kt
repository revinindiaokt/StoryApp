package com.revii.storyapp.view.register
...
import com.revii.storyapp.data.remote.payload.RegisterPayload
import com.revii.storyapp.data.remote.response.ServerErrorResponse
import com.revii.storyapp.data.remote.response.RegisterResponse
...
class RegisterViewModel : ViewModel() {
    ...
    fun register(name: String, email: String, password: String) {
        ...
        val client = NetworkConfig.getApiService().register(payload)
