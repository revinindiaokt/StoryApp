...
import com.revii.storyapp.data.remote.response.GetDetailStoryResponse
import com.revii.storyapp.data.remote.response.StoryItem
import com.revii.storyapp.utils.Event
...
class DetailStoryViewModel : ViewModel() {
    ...
    fun getDetailStory(userId: String) {
        ...
        val cilent = NetworkConfig.getApiService().getDetailStory(userId)
